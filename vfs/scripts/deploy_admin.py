...
REFS = [
    ...
    {"table_name": "customers", "columns": ["id", "name", "email", "phone", "vat", "customer_type", "ref", "contact_address", "short_name", "custom_data", "salesperson_id", "payment_term", "is_company"], "permissions": ["read", "create", "update"]},
    {"table_name": "product_templates", "columns": ["id", "name", "default_code", "sale_ok", "active", "categ_id", "list_price", "standard_price", "uom_id", "custom_data"], "permissions": ["read", "create", "update"]},
    ...
    {"table_name": "product_supplierinfo", "columns": ["id", "supplier_id", "product_tmpl_id", "product_id", "price", "min_qty", "product_code"], "permissions": ["read", "create", "delete"]},
